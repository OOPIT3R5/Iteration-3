...
public class PetView {
	...
	public PetView(){
	  ...
	  public static Image getSpriteFromAvatar(int col, int row) throws IOException {
	        return ImageIO.read(new File(System.getProperty("user.dir") + "/Assets/PetSprites.png")).getSubimage(32*col,32*row,32,32).getScaledInstance(70, 70, Image.SCALE_DEFAULT);
	    }
	...
	switch(directionFacing){
		...
		case NORTH:
			g.drawImage(getSpriteFromAvatar(5, 0), x, y, null);
			break;
			
		case SOUTH:
			
			g.drawImage(getSpriteFromAvatar(4, 0), x, y, null);

			break;
		case NORTHEAST:
			
			g.drawImage(getSpriteFromAvatar(11,1), x, y, null);

			break;
		case NORTHWEST:
			
			g.drawImage(getSpriteFromAvatar(11,6), x, y, null);

			break;
		case SOUTHWEST:
			
			g.drawImage(getSpriteFromAvatar(12, 5), x, y, null);

			break;
		case SOUTHEAST:
			
			g.drawImage(getSpriteFromAvatar(13, 3), x, y, null);
			break;
		default:
